    ...
    return (
        ...
        <div className='history-container'>
            <div className='history-text'>
                ...
                <p className='history-note'>
                    After working on several projects, I decided to learn <span style={{color: '#dd223b', fontWeight: '600', fontSize: '1.1rem'}}>React</span> and technologies connected with that liblary such as <span style={{color: '#dd223b', fontWeight: '600', fontSize: '1.1rem'}}>redux</span>, <span style={{color: '#dd223b', fontWeight: '600', fontSize: '1.1rem'}}>styled components</span> or <span style={{color: '#dd223b', fontWeight: '600', fontSize: '1.1rem'}}>firebase</span>.
                </p>
                <p className='history-note'>
