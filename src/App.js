...
const App = () => {
  ...
  const SingleProjetcsInDetails = [
    ...
    },
    {
      ...
      explanation: "The math sprint game built in JavaScript is a web application designed to test and improve users' math skills through timed quizzes and challenges. One unique feature of this app is that it saves the user's best times in local storage, allowing them to track their progress and strive to improve their performance over time.",
      technologiesExplanation: [
